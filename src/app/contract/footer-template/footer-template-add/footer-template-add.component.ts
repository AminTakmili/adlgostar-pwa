...
@Component({
  selector: 'app-footer-template-add',
  templateUrl: './footer-template-add.component.html',
  styleUrls: ['./footer-template-add.component.scss'],
})
export class FooterTemplateAddComponent implements OnInit {
	...
	async onSubmit() {
		...
		if (this.addForm.valid) {
			...
			this.global.httpPost('contractFooterTemplate/add', this.addForm.value)
