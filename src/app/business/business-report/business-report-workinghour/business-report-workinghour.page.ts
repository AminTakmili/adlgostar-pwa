...
@Component({
  selector: 'app-business-report-workinghour',
  templateUrl: './business-report-workinghour.page.html',
  styleUrls: ['./business-report-workinghour.page.scss'],
})
export class BusinessReportWorkinghourPage implements OnInit {

  pageTitle:string='گزارش های کارکرد'
  businessId:string
