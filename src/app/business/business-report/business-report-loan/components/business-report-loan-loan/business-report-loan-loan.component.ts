...
@Component({
  selector: 'app-business-report-loan-loan',
  templateUrl: './business-report-loan-loan.component.html',
  styleUrls: ['./business-report-loan-loan.component.scss'],
})
export class BusinessReportLoanLoanComponent implements OnInit {
		...
		this.columnChartOptions = {
			...
			tooltip: {
				...
				pointFormat:
					...
					'<span style="padding:0"><b>{point.y:.1f}</b></span></tr>',
				// footerFormat: '</table>',
				shared: true,
				useHTML: true,
			},
