...
@Component({
  selector: 'app-business-report-severancepay',
  templateUrl: './business-report-severancepay.component.html',
  styleUrls: ['./business-report-severancepay.component.scss'],
})
export class BusinessReportSeverancepayComponent implements OnInit {
  pageTitle:string='گزارشات حق سنوات'
...
console.log(dataSetgroupBy);
    ...
    console.log(dataCategories);
		...
		this.columnChartOptions = {
			...
			title: {
				text: Object.keys(dataSetgroupBy).length!=1?'حق سنوات':' حق سنوات سال '+Object.keys(dataSetgroupBy)[0],
			},
			subtitle: {
				text:
					' مجموع حق سنوات به تفکیک هر ماه را میتوانید مشاهده کنید ' 
