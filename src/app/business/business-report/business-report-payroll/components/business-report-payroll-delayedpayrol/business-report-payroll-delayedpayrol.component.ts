...
@Component({
  selector: 'app-business-report-payroll-delayedpayrol',
  templateUrl: './business-report-payroll-delayedpayrol.component.html',
  styleUrls: ['./business-report-payroll-delayedpayrol.component.scss'],
})
export class BusinessReportPayrollDelayedpayrolComponent implements OnInit {
...
console.log(dataSetgroupBy);
	...
	async getData(	filtered_business_id:string=this.businessId,filtered_from_date:string=this.startDate.get('filtered_from_date').value,filtered_to_date:string=this.endDate.get('filtered_to_date').value) {
		...
		// }
		this.global
			.httpPost('report/payroll/delayedPayrollList', {
