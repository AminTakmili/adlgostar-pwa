...
@Component({
  selector: 'app-employee-form-add-varriable-other',
  templateUrl: './employee-form-add-varriable-other.component.html',
  styleUrls: ['./employee-form-add-varriable-other.component.scss'],
})
export class EmployeeFormAddVarriableOtherComponent implements OnInit,OnChanges {
