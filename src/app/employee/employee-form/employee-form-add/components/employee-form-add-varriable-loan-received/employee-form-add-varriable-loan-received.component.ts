...
@Component({
  selector: 'app-employee-form-add-varriable-loan-received',
  templateUrl: './employee-form-add-varriable-loan-received.component.html',
  styleUrls: ['./employee-form-add-varriable-loan-received.component.scss'],
})
export class EmployeeFormAddVarriableLoanReceivedComponent implements OnInit {
