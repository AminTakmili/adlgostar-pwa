...
@Component({
  selector: 'app-recognizance-print',
  templateUrl: './recognizance-print.component.html',
  styleUrls: ['./recognizance-print.component.scss'],
})
export class RecognizancePrintComponent implements OnInit {

	contractBorder : boolean = false;
	pageTitle: string='پرینت تعهد نامه';
	...
	async getData(id: string) {
		...
		this.global.httpPost('recognizance/print', {
			id
